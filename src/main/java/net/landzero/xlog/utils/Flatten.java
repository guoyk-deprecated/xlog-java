    ...
    private static void mergeList(List input, String prefix, ArrayList<String> output) {
        ...
        for (Object value : input) {
            ...
            if (value instanceof Map)
                mergeMap((Map) value, prefix + String.valueOf(index) + ".", output);
            else if (value instanceof List)
                mergeList((List) value, prefix + String.valueOf(index) + ".", output);
            else
                output.add(prefix + String.valueOf(index) + "=" + value.toString());
        }
    }
}
